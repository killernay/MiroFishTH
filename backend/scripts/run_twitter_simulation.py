...
_SYSTEM_OUTPUT_TERMS = {
    ...
    "配置文件": ("configuration file", "ไฟล์การตั้งค่า"), "模拟ID": ("simulation ID", "รหัสการจำลอง"),
    "等待命令模式": ("command wait mode", "โหมดรอคำสั่ง"), "启用": ("enabled", "เปิดใช้งาน"), "禁用": ("disabled", "ปิดใช้งาน"),
